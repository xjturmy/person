...
> **状态**:✅ 已交付(2026-05-05;详见 auto-memory `project_dimension3_m0_delivered`)
> 字体/行距 CSS、选股&设置合并、收件箱并入、刷新/打开目录快捷按钮均已落地。
> sidebar 后续随 v2.7-v2.9 多次重构(导航改 5 页 radio + sub-nav,Claude 终端项已下线)。
> 本文档保留为原始设计/交付记录。
>
> 文件:[app.py](../../.tools/dashboard/app.py) — sidebar 块
> **创建**:2026-05-05 · **工作量**:1.5-2 小时(纯 UI 调整)
