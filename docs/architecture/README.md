...
>
> **版本基准**：preson v1.0（2026-06-28，版本史见根目录 [CHANGELOG.md](../../CHANGELOG.md)）  
> **用途**：后续所有功能修改、重构、新模块开发，均以此文件夹为设计基准。
>
> **当前 Dashboard 形态**（即原 v2.9 投资流水线设计）：市场&行业、选股两导航已落地 4-subtab + `funnel/` 模块；公司研究、决策中心、黄金三导航仍为早期结构，待迁移。设计详见 10/11/12 文档与 ADR-0003。
