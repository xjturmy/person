...
FOCUS_HOLDINGS: tuple[FocusHolding, ...] = (
    ...
    FocusHolding(
        ...
        kind="股票",
        sleeve="金融 / 保险",
        role="寿险龙头观察仓,与新华保险共同构成保险股暴露。",
        decision_question="保险股修复是否已经兑现,还是继续作为金融弹性仓持有？",
        review_focus="看 P/EV、NBV、偿付能力、权益市场β和与新华保险的重复暴露。",
        default_action="观察持有",
    ),
    FocusHolding(
        name="海康威视",
    ...
    FocusHolding(
        ...
        kind="股票",
        sleeve="汽车零部件 / 全球龙头",
        role="汽车玻璃全球龙头,偏价值成长观察仓。",
        decision_question="当前利润压力是短期波动,还是汽车链景气下行？",
        review_focus="看海外业务、毛利率、汽车玻璃ASP、汇率和股息稳定性。",
        default_action="价值成长验证",
    ),
    FocusHolding(
        name="蜜雪集团",
        ticker="02097",
    ...
    FocusHolding(
        ...
        sleeve="成长 / 宽基",
        role="创业板成长宽基小额观察仓。",
        decision_question="成长风格是否进入右侧,还是只作为小额观察仓？",
        review_focus="看创业板估值分位、成交热度、成长风格强弱和主题仓重复度。",
        default_action="小额观察",
    ),
    FocusHolding(
        name="有色ETF",
